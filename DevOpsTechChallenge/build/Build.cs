...
class Build : NukeBuild
{
    ...
    AbsolutePath WebProjectPath => RootDirectory / @"DevOpsTechChallenge.API\DevOpsTechChallenge.API.csproj";

    AbsolutePath PublishZipPath => RootDirectory / "DevOpsTechChallenge.API.zip";
